...
Mechanical engineering student and co-founder of **GRED** — a service marketplace platform incubated at Kerala Startup Mission. I also built **Lunar Coin**, an education-based crypto project. I build software and hardware, and I care about things that actually ship.
...
**GRED** &nbsp;`Flutter` `Firebase` `Firestore`

Customer app + Captain app. Real-time order flow. Pre-launch.

<br/>

**Lunar Coin** &nbsp;`Blockchain` `Web3` `Education`

Education-based crypto project — making blockchain concepts accessible through a hands-on coin ecosystem.

<br/>

**UAV Development** &nbsp;`Pixhawk` `ArduPilot`

Autonomous drone build — flight control, sensor fusion, mission planning.

<br/>

**Linear Electromagnetic Shock Absorber** &nbsp;`MATLAB` `CAD`

Energy harvesting from vehicle vibration through electromagnetic induction.

<br/>

**AI + Physical Systems** &nbsp;`ESP32` `TensorFlow Lite`

ML on microcontrollers, autonomous control experiments.
